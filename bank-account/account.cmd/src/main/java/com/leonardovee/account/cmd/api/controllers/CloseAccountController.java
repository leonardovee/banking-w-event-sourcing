...
import com.leonardovee.account.cmd.api.commands.CloseAccountCommand;
...
public class CloseAccountController {
    ...
    public ResponseEntity<BaseResponse> closeAccount(@PathVariable(value = "id") String id) {
        try {
            ...
            var safeErrorMessage = MessageFormat.format("Error while processing request to close the bank account for id - {0}.", id);
